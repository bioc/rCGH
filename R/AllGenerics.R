...
setGeneric("getSegTable",
    def=function(object) standardGeneric("getSegTable"))
...
setGeneric("EMnormalize",
    def=function(object, cut=c(.01, .99), G=2:6, useN=25e3, peakThresh=0.5,
        ksmooth=NA, mergeVal=0.1, Title=NA, verbose=TRUE)
    standardGeneric("EMnormalize"))
setGeneric("segmentCGH",
    def=function(object, Smooth=TRUE, UndoSD=NULL, minMarks=8, nCores=NULL,
        verbose=TRUE)
    standardGeneric("segmentCGH"))
setGeneric("byGeneTable",
    def=function(object, verbose=TRUE) standardGeneric("byGeneTable"))
setGeneric("plotDensity",
    def=function(object, breaks=NULL, Title=NULL,...)
    standardGeneric("plotDensity"))
setGeneric("plotProfile",
    def=function(object, gene=NULL, gain=.5, loss=(-.5), Title=NULL, ylim=NULL)
    standardGeneric("plotProfile"))
setGeneric("plotLOH",
    def=function(object, Title=NULL) standardGeneric("plotLOH"))
setGeneric("multiplot",
    def=function(object, gene=NULL, gain=.5, loss=(-.5), L=matrix(seq(1, 12)), 
        p=c(2/3, 1/3), Title=NULL, ylim=NULL)
